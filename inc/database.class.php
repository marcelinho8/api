...
class GDbMysql {
     ...
     *
     */
    function __construct($mysql_host = MYSQL_HOST, $mysql_user = MYSQL_USER, $mysql_pass = MYSQL_PASS, $mysql_base = MYSQL_BASE, $mysql_port = MYSQL_PORT, $mysql_charset = MYSQL_CHARSET, $mysql_timezone = MYSQL_TIMEZONE) {
        $arrTimezone = getTimezone();
        try {
            $this->connect($mysql_host, $mysql_user, $mysql_pass, $mysql_base, $mysql_port, $mysql_charset);
            if (SERVER == 'D') {
                $this->execute("SET time_zone = '" . $arrTimezone['offset'] . "';", null, false);
            } else {
                $this->execute("SET time_zone = '" . $arrTimezone['tz'] . "';", null, false);
            }
     ...
     *
     */
    private function connect($mysql_host, $mysql_user, $mysql_pass, $mysql_base, $mysql_port, $mysql_charset) {
